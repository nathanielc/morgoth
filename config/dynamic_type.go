...
func (self *DynamicConfiguration) GetConf() Configuration {
	return self.Conf
}
...
func (self *DynamicConfiguration) PerformGetInstance(r *Registery) (interface{}, error) {
	factory, err := r.GetFactory(self.Type)
	if err != nil {
		return nil, err
	}
...
func (self *DynamicConfiguration) PerformUnmarshalYAML(registery *Registery, unmarshal func(interface{}) error) error {
