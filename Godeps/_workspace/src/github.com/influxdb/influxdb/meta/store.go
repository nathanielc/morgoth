...
import (
	...
	"github.com/nathanielc/morgoth/Godeps/_workspace/src/github.com/hashicorp/raft"
	"github.com/nathanielc/morgoth/Godeps/_workspace/src/github.com/influxdb/influxdb/influxql"
	"github.com/nathanielc/morgoth/Godeps/_workspace/src/github.com/influxdb/influxdb/meta/internal"
	"github.com/nathanielc/morgoth/Godeps/_workspace/src/golang.org/x/crypto/bcrypt"
)

const (
	MuxRaftHeader = // tcp.Mux header bytes.
	0
	MuxExecHeader = 1
	MuxRPCHeader  = 5
