...
import (
	...
	"github.com/nathanielc/morgoth/Godeps/_workspace/src/github.com/influxdb/influxdb/tsdb/internal" // ErrFieldOverflow is returned when too many fields are created on a measurement.
)
